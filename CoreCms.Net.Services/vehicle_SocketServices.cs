...
namespace CoreCms.Net.Services
{
    ...
    /// 车辆日志表 接口实现
    /// </summary>
    public class vehicle_SocketServices : BaseServices<vehicle_log>, Ivehicle_SocketServices
    {
        private readonly Ivehicle_SocketRepository _dal;
        ...
        public vehicle_SocketServices(
            IUnitOfWork unitOfWork
            , Ivehicle_SocketRepository dal
            , IMapper Mapper
