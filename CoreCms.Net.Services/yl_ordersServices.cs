...
namespace CoreCms.Net.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class yl_ordersServices : BaseServices<yl_orders>, Iyl_ordersServices
    {
        private readonly Iyl_ordersRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public yl_ordersServices(IUnitOfWork unitOfWork, Iyl_ordersRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
