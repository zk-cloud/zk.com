...
namespace CoreCms.Net.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class yl_addressServices : BaseServices<yl_address>, Iyl_addressServices
    {
        private readonly Iyl_addressRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public yl_addressServices(IUnitOfWork unitOfWork, Iyl_addressRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
