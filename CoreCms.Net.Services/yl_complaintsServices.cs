...
namespace CoreCms.Net.Services
{
    ...
    ///  接口实现
    /// </summary>
    public class yl_complaintsServices : BaseServices<yl_complaints>, Iyl_complaintsServices
    {
        private readonly Iyl_complaintsRepository _dal;
        private readonly IUnitOfWork _unitOfWork;

        public yl_complaintsServices(IUnitOfWork unitOfWork, Iyl_complaintsRepository dal)
        {
            this._dal = dal;
            base.BaseDal = dal;
