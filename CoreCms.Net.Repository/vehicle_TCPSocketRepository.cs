...
namespace CoreCms.Net.Repository
{
    ...
    /// 车辆日志表 接口实现
    /// </summary>
    public class vehicle_TCPSocketRepository : BaseRepository<vehicle_log>, Ivehicle_TCPSocketRepository
    {
        private readonly IUnitOfWork _unitOfWork;
        public vehicle_TCPSocketRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
