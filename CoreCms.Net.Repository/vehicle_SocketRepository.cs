...
namespace CoreCms.Net.Repository
{
    ...
    /// 车辆日志表 接口实现
    /// </summary>
    public class vehicle_SocketRepository : BaseRepository<vehicle_log>, Ivehicle_SocketRepository
    {
        private readonly IUnitOfWork _unitOfWork;
        public vehicle_SocketRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
